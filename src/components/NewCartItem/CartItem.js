  ...
  render() {
    return (
      ...
      >
        ...
        <Row>
          <Col className='itemNameAndImageContainer'>
            <div
              className='itemImage'
          ...
          <Col>
            <div>
              {this.disableQuantity || this.props.customboxid ? (
                      ...
                      <>
                      <span className='totalAndPrice discount'>Cantidad: </span>
                      <InputNumber
                        min={1}
              ...
              <div className="cta-container">
                {this.disableDelete ? null : this.props.customboxid &&
                      ...
                      <button className='cta-delete' onClick={this.handleDelete} style={{ width: "100%" }}>
                        Eliminar
                      </button>
                    )}
              </div>
